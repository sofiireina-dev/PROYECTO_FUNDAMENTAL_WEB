...
function factura() {
    window.location.href = "https://tiendafundamental.duckdns.org/tcpdf/examples/generarFacturaPDF.php";
}

function setDatos(precio) {
    var precioParametro = encodeURIComponent(precio);
    var url = 'https://tiendafundamental.duckdns.org/exito.php?precio=' + precioParametro;
    window.location.href = url;
}

function exito(precio) {
    window.location.href = "https://tiendafundamental.duckdns.org/exito.php?precio=" + precio;
}